...
interface PresetFormTabProps {
  t: Translations;
  obj: AnyObj;
  setObj: Dispatch<SetStateAction<AnyObj>>;
}

/**
 * The structured (non-JSON) editor for an `.export.json` preset. Owns all the
 * field setters/accessors over `obj`; the parent only holds the `obj` state and
 * the JSON tab. Split out of PresetEditorModal in v0.3.2.
 */
export function PresetFormTab({ t, obj, setObj }: PresetFormTabProps) {
