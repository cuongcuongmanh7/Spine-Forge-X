...
export const copy = {
  vi: {
    ...
    cleanSourcePreExport: 'Pre-export: dọn ảnh thừa trước khi pack…',
    ...
    autoCleanBeforeExport: 'Tự dọn ảnh thừa trước khi export (pack folder)',
  ...
  en: {
    ...
    cleanSourcePreExport: 'Pre-export: cleaning unused images before packing…',
    ...
    autoCleanBeforeExport: 'Auto-clean unused images before export (pack folder)',
